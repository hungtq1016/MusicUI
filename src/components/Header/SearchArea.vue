            ...
            <DialogPanel
              ...
              <div class="w-full">
                <div class="inline-flex w-full flex-col justify-center relative text-gray-500">
                  <div class="flex items-center gap-x-2 rounded border border-gray-200 ">
                    <button type="button" class="focus:outline-none">
                      <MagnifyingGlassIcon class="w-5 h-5 ml-4" />
                    </button>
                    <input type="text" v-model="search"
                      class="p-2 w-full bg-gray-200 focus:bg-white focus:outline-none focus:ring-0 focus:border-transparent rounded"
                  ...
                  <ul class="bg-white divide-y-[1px] divide-gray-500 w-full mt-2 ">
                    <li v-for="item in updatedData" :key="item._id"
                      ...
                      <a href="#" class="justify-between flex">
                        ...
                        <RouterLink :to="getPath('api.'+item._index)" class="capitalize text-sky-700">{{ item._index }}</RouterLink>
                      </a>
                    </li>
                  </ul>
                </div>
...
import type { IHit, IRootObject } from '@/types/interface';
import type { TOption } from '@/types/type';
