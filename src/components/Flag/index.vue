  ...
  <div class="basis-1/5">
    <div class="-m-1.5 flex items-center p-1.5">
      ...
      <select v-model="$i18n.locale"  @change="changeLocale($i18n.locale)"
        class="relative cursor-default rounded-lg bg-white py-2 pl-3 pr-10 text-left focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm border-0">
