<template>
  <div class="group relative flex justify-center items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out ">
      ...
      <select v-model="$i18n.locale"  @change="changeLocale($i18n.locale)"
        class="bg-transparent dark:bg-meta-4">
