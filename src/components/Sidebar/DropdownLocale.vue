<template>
  <div class="group relative flex justify-center items-center gap-2.5 rounded-md px-4 font-medium text-regent-gray-600  duration-300 ease-in-out ">
      ...
      <select v-model="$i18n.locale"  @change="changeLocale($i18n.locale)"
        class="bg-transparent dark:bg-oxford-blue-900">
