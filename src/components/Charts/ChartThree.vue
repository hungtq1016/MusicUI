...
<template>
  <div
    class="col-span-12 rounded-sm border border-zumthor-100 bg-white px-5 pt-7.5 pb-5 shadow-default dark:border-oxford-blue-900 dark:bg-big-stone-950  sm:px-7.5 xl:col-span-5"
  >
